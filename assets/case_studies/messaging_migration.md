...
1. Build an independent messaging solution.
2. Use a versioned API to delegate to the correct implementation.
3. Create a service class to synchronize the two.
4. Backfill existing conversations into the new solution.
